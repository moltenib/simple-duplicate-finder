...
- Adler-32 was made for block parity calculation rather than hashing, and is particularly not reliable with small files. It often returns the same amount of results as SHA-1.
